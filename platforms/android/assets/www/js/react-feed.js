                    ...
                    <div className="card-content-inner">
                      ...
                      <div className="row">
                        <div className="row widthfull">
                          <div className="col-33">
                            <b>Distance: </b>{object.data.distance}
                          </div>
                          <div className="col-33">
                            <b>Average: </b>{object.data.avg}
                          </div>
                          <div className="col-33">
        ...
        <div className="block paper-popup">
          <div className="box">
            <div className="row">
              <div className="col-33">
                <div className="paper-label color1">
                  <h1 className="top">{this.props.data.distance/1000}</h1>
                  <h1 className="bottom">KM</h1>
                </div>
              </div>
              <div className="col-33">
                <div className="paper-label color3">
                  <h1 className="top">{this.props.data.avg}</h1>
        ...
        <div className="card facebook-card" obj={this.data}>
          ...
          <div className="card-content">
            <div className="card-content-inner">
              ...
              <div className="row widthfull">
                <div className="col-33">
                  <b>Distance: </b>{this.props.data.distance}
                </div>
                <div className="col-33">
                  <b>Average: </b>{this.props.data.avg}
                </div>
                <div className="col-33">
